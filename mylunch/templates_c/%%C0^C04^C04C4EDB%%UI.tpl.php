<?php /* Smarty version 2.6.32, created on 2021-11-15 03:36:09
...
?>
    <table>
        <tr>
            ...
            <td><a href='/kadai/mylunch/controller/SQL_Edit_controller.php?index=<?php echo $this->_tpl_vars['row'][0]; ?>
' class='edit'>編集</a></td>
        </tr>
    </table>
...
?>    <?php $this->assign('i', $this->_sections['bar']['iteration']); ?>
        <a href="/kadai/mylunch/controller/UI_controller.php?page=<?php echo $this->_tpl_vars['i']; ?>
