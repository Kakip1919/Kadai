<?php /* Smarty version 2.6.32, created on 2021-11-18 09:33:54
...
日です</h3>
    ...
    <h2 class="text-center today_subtitle"><?php echo $this->_tpl_vars['subtitle']; ?>
</h2>
    <h2 class="text-center result_cal"><?php echo $this->_tpl_vars['cal_result']; ?>
</h2>
    <?php endif; ?>
    </div>
    <?php if ($this->_tpl_vars['wareki_flag'] == 1): ?>
        <h3 class="text-center"><?php echo $this->_tpl_vars['wareki_subtitle']; ?>
<?php echo $this->_tpl_vars['wareki_result']; ?>
</h3>
    <?php endif; ?>
